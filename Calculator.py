...
#test git
root = Tk()
root.title("Simple Additin Calculator")
#12321321
...
button_multiply = Button(root, text="*", padx=25, pady=20, command=button_multiply)
button_divide = Button(root, text="/", padx=25, pady=20, command=button_divide)
